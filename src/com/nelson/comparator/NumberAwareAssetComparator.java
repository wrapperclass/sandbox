package org.lds.drps.repo.rosetta.job;
...
import org.lds.drps.sip.support.Asset;

public class NumberAwareAssetComparator implements Comparator<Asset> {

	public static final NumberAwareAssetComparator INSTANCE = new NumberAwareAssetComparator();

	private static final Pattern PATTERN = Pattern.compile("(\\D*)(\\d*)");

	public NumberAwareAssetComparator() {
	}

	public int compare(Asset a1, Asset a2) {
		Matcher m1 = PATTERN.matcher(a1.getRelativePath());
		Matcher m2 = PATTERN.matcher(a2.getRelativePath());
